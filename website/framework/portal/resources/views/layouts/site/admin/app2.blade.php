...
<body id="page-top">
  ...
  <!-- Page Wrapper -->
  <div id="wrapper">
    @include('includes.layout.site.admin.newlayout.sidebar')
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column">
      <!-- Main Content -->
      <div id="content">
        @include('includes.layout.site.admin.newlayout.topbar')
        <!-- Begin Page Content -->
      ...
      <!-- End of Main Content -->
      @include('includes.layout.site.admin.newlayout.footer')
    </div>
