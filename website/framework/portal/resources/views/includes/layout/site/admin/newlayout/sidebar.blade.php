...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="collapseAcl" class="collapse" aria-labelledby="headingAcl" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Access Control List:</h6>
              <a class="collapse-item" href="{{ route('perfil.index') }}">Perfil de Usuário</a>
              <a class="collapse-item" href="{{ route('permissao.index') }}">Permissões</a>
