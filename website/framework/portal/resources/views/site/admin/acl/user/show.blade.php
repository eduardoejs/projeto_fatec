                ...
                <div class="card border-warning mb-3">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                            ...
                            <p>Ao excluir um usuário do sistema, todas as informações vinculadas à ele ou relacionadas com outros recursos serão excluídas automaticamente não sendo possível sua recuperação.</p>
                            <hr>
                        ...
                        <h5 class="card-title mt-3 mb-0">Usuário: {{ $registro->nome }}</h5>
                        <p class="mb-0">CPF: {{ $registro->cpf }}</p>
                        <p class="mb-0">E-mail: {{ $registro->email }}</p>
                        <p class="mb-0">Tipo de usuário: {!! $registro->tipoUser !!}</p>
