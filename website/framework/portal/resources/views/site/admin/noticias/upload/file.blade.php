                                    ...
                                    <td class="align-middle">
                                        <div class="dropdown align-middle">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="dropdownMenuButton"> 
                                                @form_component(['action' => route($routeName.'.delete.file', ['news' => $noticia->id, 'fileId' => $arquivo->id, 'typeDownload' => 'file']), 'method' => 'DELETE'])                                               
                                                    <button type="submit" class="dropdown-item text-secondary"><i class="fa fa-trash"></i> Excluir</button>
                                                @endform_component
                                                <a class="dropdown-item text-secondary" href="{{ route($routeName.'.download.file', ['news' => $noticia->id, 'fileId' => $arquivo->id, 'typeDownload' => 'file']) }}"><i class="fa fa-download"></i> Download</a>                                            
                                            </div>
                                        </div>                                                  
                                    </td>
                                </tr>
