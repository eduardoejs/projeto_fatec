                                    ...
                                    <tbody>
                                        @forelse ($cursos as $curso)
                                            <tr>
                                                ...
                                                <td>{{$curso->nome}}</td>
                                                <td>
                                                    @foreach ($curso->getCoordenador($curso->id) as $coordenador)
                                                        {{$coordenador->nome}}
                                                    @endforeach</td>
                                                <td>{{$curso->periodo}}</td>
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <div class="dropdown no-arrow">
                            ...
                            <div class="d-none dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                <div class="dropdown-header">Opções:</div>
                                <a href="#" class="btn btn-outline-success btn-sm btn-icon-split dropdown-item">
                                    <span class="icon text-white bg-success"><i class="fas fa-plus"></i></span>
