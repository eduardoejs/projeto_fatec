    ...
    <div class="form-group col-md-12">
        ...
        <div class="input-group mt-3">                                                
            ...
            <span class="help-block">
                Selecione um arquivo para o curso. Formatos aceitos: <i class="far fa-file-pdf text-danger"></i> <i class="far fa-file-word text-primary"></i> <i class="far fa-file-excel text-success"></i> <i class="far fa-file-powerpoint text-danger"></i> <i class="fas fa-file-archive text-secondary"></i> 
            </span>                        
        </div>
    </div>            
</div>
