                ...
                <div class="card border-warning mb-3">
                    ...
                    <div class="card-body">
                        <div class="alert alert-warning" role="alert">
                            ...
                            <p>Ao excluir uma notícia do sistema, todas as informações vinculadas à ela ou relacionadas com outros recursos serão excluídas automaticamente não sendo possível sua recuperação.</p>
                            <hr>
                        ...
                        <h5 class="card-title mt-3 mb-0">Notícia: {{ $registro->titulo }}</h5> 
                        <hr>
